...
![image.png](Phase%201%20Setup%20and%20Connectivity/image.png)
...
![image.png](Phase%201%20Setup%20and%20Connectivity/image%201.png)

and finally the win10 installation media

- [https://www.microsoft.com/en-us/software-download/windows10](https://www.microsoft.com/en-us/software-download/windows10)

![image.png](Phase%201%20Setup%20and%20Connectivity/image%202.png)

## **2-Configure VMs**

for windows 10(client ):

![image.png](Phase%201%20Setup%20and%20Connectivity/image%203.png)

       for win10 server (DC)

![image.png](Phase%201%20Setup%20and%20Connectivity/image%204.png)

![image.png](Phase%201%20Setup%20and%20Connectivity/image%205.png)

![image.png](Phase%201%20Setup%20and%20Connectivity/image%206.png)
...
![image.png](Phase%201%20Setup%20and%20Connectivity/image%207.png)

and in the network settings we put 

![image.png](Phase%201%20Setup%20and%20Connectivity/image%208.png)
...
![Screenshot 2026-01-31 130501.png](Phase%201%20Setup%20and%20Connectivity/Screenshot_2026-01-31_130501.png)
...
![image.png](Phase%201%20Setup%20and%20Connectivity/image%209.png)
...
![image.png](Phase%201%20Setup%20and%20Connectivity/image%2010.png)

disable IPv6 and go to IPv4 Properties 

![image.png](Phase%201%20Setup%20and%20Connectivity/image%2011.png)
...
![image.png](Phase%201%20Setup%20and%20Connectivity/image%2012.png)

in system proprties change the name of the Windows server computre to DC_server

![image.png](Phase%201%20Setup%20and%20Connectivity/image%2013.png)
...
![image.png](Phase%201%20Setup%20and%20Connectivity/image%2014.png)
...
![image.png](Phase%201%20Setup%20and%20Connectivity/image%2015.png)
...
![image.png](Phase%201%20Setup%20and%20Connectivity/image%2016.png)

and finally both of them can ping each others 

![image.png](Phase%201%20Setup%20and%20Connectivity/image%2017.png)

![image.png](Phase%201%20Setup%20and%20Connectivity/image%2018.png)

### B-Resolve DNS

- trying to ping **Windows server** computre name :

![image.png](Phase%201%20Setup%20and%20Connectivity/image%2019.png)
...
![image.png](Phase%201%20Setup%20and%20Connectivity/image%2020.png)

next next then 

![image.png](Phase%201%20Setup%20and%20Connectivity/image%2021.png)

check both of **Active Directory Domain Services** and **DNS Server and add them as feature** 

![image.png](Phase%201%20Setup%20and%20Connectivity/image%2022.png)

make sure the group policy Mangement is checked 

![image.png](Phase%201%20Setup%20and%20Connectivity/image%2023.png)

then next next and install

![image.png](Phase%201%20Setup%20and%20Connectivity/image%2024.png)

and after the installation finished 

![image.png](Phase%201%20Setup%20and%20Connectivity/image%2025.png)
...
![image.png](Phase%201%20Setup%20and%20Connectivity/image%2026.png)

next we set up Domain controller Options 

![image.png](Phase%201%20Setup%20and%20Connectivity/image%2027.png)

as the passowrd for DSRM is **`fr0ma4arw$p6y`**

![image.png](Phase%201%20Setup%20and%20Connectivity/image%2028.png)

just dont :”) 

and the NetBIOS domain name as **`SECURINETSENIT`**

![image.png](Phase%201%20Setup%20and%20Connectivity/image%2029.png)

next next then install 

![image.png](Phase%201%20Setup%20and%20Connectivity/image%2030.png)

after quick restart we go to server manager\dashboard then tools \Active Directory Users and Computers

![image.png](Phase%201%20Setup%20and%20Connectivity/image%2031.png)

we will try to add the client computre to the computers folder in the forest sercurinets.local

![image.png](Phase%201%20Setup%20and%20Connectivity/image%2032.png)

in the client we head torward settings\about the scroll down for Advance system settings

![image.png](Phase%201%20Setup%20and%20Connectivity/image%2033.png)

then Computer Name,change,check Domain and set name to our DC domain name **securinetsenit.local** 

![image.png](Phase%201%20Setup%20and%20Connectivity/image%2034.png)
...
![image.png](Phase%201%20Setup%20and%20Connectivity/image%2035.png)

</aside>

put the username and password of the Admin DC

![image.png](Phase%201%20Setup%20and%20Connectivity/image%2036.png)

![image.png](Phase%201%20Setup%20and%20Connectivity/image%2037.png)

everything is going great 

now in the DC the client will apear in the computers forest 

![image.png](Phase%201%20Setup%20and%20Connectivity/image%2038.png)
...
![image.png](Phase%201%20Setup%20and%20Connectivity/image%2039.png)

![image.png](Phase%201%20Setup%20and%20Connectivity/image%2040.png)
